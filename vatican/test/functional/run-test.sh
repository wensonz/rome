...
package=$1
package_name="sinasrv2-rome-vatican"
name="vatican"
version="0.1.0-1"
git_url="git://10.210.213.9/rome/vatican.git"
...
run_cmd 10.210.226.159 "cd /data0/package && rpm -e $package_name &&  yum -y install $package"
ssh 10.210.226.159 "cd /usr/local/sinasrv2/rome/vatican/src; cp -f config.json.bak config.json"
